...
namespace Prototype.ScreenManager.Screens
{
    class GameOverScreen : Screen
    {
        ...
        public override void Draw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(background, new Rectangle(0, 0, ScreenManager.Width, ScreenManager.Height/2), null, Color.White, 0.0f, Vector2.Zero, SpriteEffects.None, 0);
            spriteBatch.DrawString(gameOverFont, "Game Over", new Vector2(ScreenManager.Width/2 - continueFont.MeasureString("Game Over").X, ScreenManager.Height/2 - continueFont.MeasureString("Game Over").Y), Color.White, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, 1);
            spriteBatch.DrawString(gameOverFont, "Game Over", new Vector2(ScreenManager.Width/2 - continueFont.MeasureString("Game Over").X, ScreenManager.Height / 2 - continueFont.MeasureString("Game Over").Y/2), Color.Black, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.FlipVertically, 1);
        }
